...
export const orElse =
  <S, R, E1, A, E2>(onLeft: (e: E1) => SRTE.StateReaderTaskEither<S, R, E2, A>) =>
  (ma: SRTE.StateReaderTaskEither<S, R, E1, A>): SRTE.StateReaderTaskEither<S, R, E2, A> =>
  s =>
  r => pipe(ma(s)(r), TE.orElse(e => onLeft(e)(s)(r)));

export const orElseW =
  <S, R, E1, A, E2, B>(onLeft: (e: E1) => SRTE.StateReaderTaskEither<S, R, E2, B>) =>
  (ma: SRTE.StateReaderTaskEither<S, R, E1, A>): SRTE.StateReaderTaskEither<S, R, E2, A | B> =>
  s =>
  r => pipe(ma(s)(r), TE.orElseW(e => onLeft(e)(s)(r)));
...
s =>
r => pipe(ma(s)(r), TE.orElseFirst(e => onLeft(e)(s)(r)));

export const orElseFirstW =
  <S, R, E1, A, E2, B>(onLeft: (e: E1) => SRTE.StateReaderTaskEither<S, R, E2, B>) =>
  (ma: SRTE.StateReaderTaskEither<S, R, E1, A>): SRTE.StateReaderTaskEither<S, R, E1 | E2, A> =>
  s =>
  r => pipe(ma(s)(r), TE.orElseFirstW(e => onLeft(e)(s)(r)));

export const orElseTaskEither =
  <S, R, E1, A, E2>(onLeft: (e: E1) => TE.TaskEither<E2, A>) =>
  (ma: SRTE.StateReaderTaskEither<S, R, E1, A>): SRTE.StateReaderTaskEither<S, R, E2, A> =>
  s =>
  r => pipe(ma(s)(r), TE.orElse(flow(onLeft, TE.map((a) => [a, s] as const))));
