...
export const getByIdO = (drivewsid: string) => (cache: CT.Cache): O.Option<CT.CacheEntity> => {
  return pipe(cache.byDrivewsid, R.lookup(drivewsid));
};

export const getByIdE = (drivewsid: string) => (cache: CT.Cache): E.Either<NotFoundError, CT.CacheEntity> => {
  return pipe(
...
export const getFolderDetailsByIdE = (drivewsid: string) => (cache: CT.Cache): E.Either<Error, CT.CacheEntity> => {
  return pipe(
    getByIdO(drivewsid)(cache),
...
export const getHierarchyById = (drivewsid: string) => (cache: CT.Cache): E.Either<NotFoundError, T.Hierarchy> => {
  const h: T.Hierarchy = [];
...
export const getCachedPathForId = (drivewsid: string) => (cache: CT.Cache): E.Either<NotFoundError, string> => {
  return pipe(
...
export const removeById = (drivewsid: string): (cache: CT.Cache) => CT.Cache => (cache: CT.Cache) =>
  pipe(cache, lens.byDrivewsid.modify(R.deleteAt(drivewsid)));
...
export const removeByIds = (drivewsids: string[]) => (cache: CT.Cache): LookupCache =>
  pipe(
    drivewsids,
